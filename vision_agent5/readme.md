...
4. #### 실행
<img src = "play01.png" width="500" height="280">
먼저 영상수집 버튼을 누르고 c버튼을 눌러 여러 장의 사진을 이어질 수 있도록 찍는다. 그다음 q를 눌러 카메라에서 나간다.
<img src = "play02.png" width="500" height="280">
그 다음 영상 보기를 눌러 사진이 제대로 잘 찍혔는지 확인한다.
<img src = "play03.png" width="500" height="280">
마지막으로 봉합을 누르면 사진이 하나로 합쳐져서 사진과 같이 나온다. 그 다음 저장을 하거나 나가기를 누른다.